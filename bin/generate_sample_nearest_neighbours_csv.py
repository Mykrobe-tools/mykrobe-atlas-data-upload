...
def _generate_requests(sample_mapping_csv, sample_nearest_neighbours_filepath, distance_threshold):
    isolate_to_tracking = {}
...
if __name__ == '__main__':
    ...
    _generate_requests(args.sample_mapping_csv, args.sample_nearest_neighbours_filepath, args.distance_threshold)
